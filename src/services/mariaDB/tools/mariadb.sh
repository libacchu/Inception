...
echo "CREATE DATABASE IF NOT EXISTS $WORDPRESS_DB_DATABASE; GRANT ALL ON $WORDPRESS_DB_DATABASE.* TO '$WORDPRESS_USER_LOGIN'@'%' IDENTIFIED BY '$WORDPRESS_USER_PASSWORD'; FLUSH PRIVILEGES;" | mysql -u root
